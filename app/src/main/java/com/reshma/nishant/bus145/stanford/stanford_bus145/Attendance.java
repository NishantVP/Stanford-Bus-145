...
public class Attendance {
    ...
    public static ArrayList<Attendance> getRecipesFromFile(String filename, Context context){
        final ArrayList<Attendance> recipeList = new ArrayList<>();
        ...
        try {
            ...
            for(int i = 0; i < recipes.length(); i++){
                Attendance recipe = new Attendance();
